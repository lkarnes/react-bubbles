...
tokens are used to authenticate users and are stored in localstorage
- [ ] What steps can you take in your web apps to keep your data secure?
make a private route and a axiosWithAuth to verify and set a token that only allows users on the page if they have a token from logging in
- [ ] Describe how web servers work.
a web server takes the website under a domain and when someone types that domain in browser the server sends that computer the webpage
